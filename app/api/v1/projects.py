...
from app.schemas.projects import BaseProjectCreateUpdate, BaseProjectRead, ProjectCreate, PatchProjectUpdateRequest, \
    ProjectReadMembers
...
@project_routes.get("/get_project_by_id/{project_id}/",
                    status_code=200,
...
@project_routes.patch("/update_project/{project_id}/", status_code=200, response_model=BaseProjectCreateUpdate)
...
@project_routes.delete("/delete_project_by_id/{project_id}/", status_code=200)
